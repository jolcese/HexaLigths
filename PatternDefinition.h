...
PatternStructureList g_patterns = {
  ...
  { "Palette - Purple and Green",               &color_palette,         8,        4,        0 },
  ...
  { "Reel-juggle",                              &juggle,                8,        0,        0 },
  { "Reel-bpm",                                 &bpm,                   8,        0,        0 },
  { "Cylon",                                    &cylon,                 30,       0,        200 },
  { "Solid Backround Loop",                     &solid_background,      20,       0,        0 },
  { "Solid Backround Controlled",               &solid_background,      20,       1,        1 },
